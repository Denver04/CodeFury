            ...
            render: function(data,type){
                if(type === "display"){
                    if(data === "In Progress")
                        ...
                        return `<div class="d-flex justify-content-center"><span class="w-100 badge text-bg-primary rounded-pill p-2">${data}</span></div>`
                    else if(data === "Closed")
                        return `<div class="d-flex justify-content-center"><span class="w-100 badge text-bg-success rounded-pill p-2">${data}</span></div>`
                }
                return data;
            }
        },
        ...
        { data: "createdOn",
            render: function(data,type){
                if(type === "display"){
                    ...
                    const timeFormatter = new Intl.DateTimeFormat('en-GB', optionsTime);
